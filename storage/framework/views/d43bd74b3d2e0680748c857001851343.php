    ...
    <div class="back">
        <header class="header">
            <div class="container">
                ...
                <nav class="nav">
                    <ul class="nav-list">
                        <li class="nav-item"><a href="<?php echo e(route('welcome')); ?>">Home</a></li>
    ...
    <div class="container-form">
        <div class="content">
            ...
            <div class="right-side">
                ...
                <form action="<?php echo e(route('contect.submit')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="input-box">
...
</html><?php /**PATH D:\xampp\htdocs\School_Management\resources\views/contectus.blade.php ENDPATH**/ ?>